...
import 'package:prag_cat_breed/features/cat_breed/presentation/widgets/lista_cat_cards.dart';
  ...
  Widget build(BuildContext context) {
    return Platform.isIOS
        ? CupertinoPageScaffold(
            ...
            child: SafeArea(child: CatBreedsScreenContent()),
          )
        : Scaffold(
            appBar: AppBar(
            ...
            body: CatBreedsScreenContent(),
          );
  }
}

class CatBreedsScreenContent extends ConsumerStatefulWidget {
  const CatBreedsScreenContent({super.key});

  @override
  ConsumerState<CatBreedsScreenContent> createState() =>
      _CatBreedsScreenState();
}

class _CatBreedsScreenState extends ConsumerState<CatBreedsScreenContent> {
