...
import 'package:prag_cat_breed/features/cat_breed/domain/use_cases/get_image_breeds_use_case.dart';
...
final getBreedImagesUseCaseProvider =
    Provider<GetImageBreedsUseCase>((ref) {
  final repo = ref.watch(catBreedRepositoryProvider);
  return GetImageBreedsUseCase(repo);
});
